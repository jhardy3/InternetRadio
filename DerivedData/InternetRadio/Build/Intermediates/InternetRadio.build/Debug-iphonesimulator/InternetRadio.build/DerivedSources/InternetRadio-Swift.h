...
SWIFT_CLASS("_TtC13InternetRadio11AppDelegate")
...
@interface NSDate (SWIFT_EXTENSION(InternetRadio))
...
SWIFT_CLASS("_TtC13InternetRadio17ShowTableViewCell")
...
SWIFT_CLASS("_TtC13InternetRadio20StationTableViewCell")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified stationDetailLabel;
- (void)awakeFromNib;
- (void)setSelected:(BOOL)selected animated:(BOOL)animated;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC13InternetRadio22StationsViewController")
...
@interface StationsViewController (SWIFT_EXTENSION(InternetRadio)) <UITableViewDelegate, UIScrollViewDelegate, UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)tableView;
- (void)tableView:(UITableView * _Nonnull)tableView didDeselectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
